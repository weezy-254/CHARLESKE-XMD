...
zokou({ nomCom: "scan","pair", categorie: "General" }, async (dest, zk, commandeOptions) => {
 ...
 *STEPS TO GET SESSION*
 ...
 3. Charleske  will sent you a code. Copy that code. Then whatsapp will sent Notification
