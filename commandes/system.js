...
zokou({
  ...
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or CHARLES-KE owner 💀*");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or CHARLES-KE💀*");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or  owner 💀*");
  }
